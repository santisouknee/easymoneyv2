              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-end">
                ...
                <div className="sm:col-span-3">
                  ...
                  <input
                    ...
                    value={`${interestRate}%`}
                    readOnly
                    className="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-sm text-slate-800 dark:text-white focus:outline-none cursor-not-allowed font-semibold"
                  />
                </div>
